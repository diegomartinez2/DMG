...
#        hessian_data3 = np.loadtxt("3_hessian_vs_configuraciones.dat")
        ...
        plt.plot(hessian_data[:,0], hessian_data[:,1], label = "Min SCHA freq", marker = ">")
        plt.plot(hessian_data[:,0], hessian_data[:,2], label = "Free energy curvature", marker = "o")
        plt.plot(hessian_data1[:,0], hessian_data1[:,1], label = "Min SCHA freq", marker = ">")
        plt.plot(hessian_data1[:,0], hessian_data1[:,2], label = "Free energy curvature", marker = "o")
#        plt.plot(hessian_data2[:,0], hessian_data2[:,1], label = "Min SCHA freq", marker = ">")
#        plt.plot(hessian_data2[:,0], hessian_data2[:,2], label = "Free energy curvature", marker = "o")
#        plt.plot(hessian_data3[:,0], hessian_data3[:,1], label = "Min SCHA freq", marker = ">")
#        plt.plot(hessian_data3[:,0], hessian_data3[:,2], label = "Free energy curvature", marker = "o")
        plt.axhline(0, 0, 1, color = "k", ls = "dotted") # Draw the zero
...
#    Temperatura_i = np.linspace(50, 300, 6)
    ...
    Configuraciones_i = [2**4,2**5,2**6,2**7,2**8,2**9,2**10,2**12,2**14]
#    Configuraciones_i = [2**9,2**10]
#    Configuraciones_i = range(16,1024,10)#range(1024,32,-32) #range(32, 512, 2)
