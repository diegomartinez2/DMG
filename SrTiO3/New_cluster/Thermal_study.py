...
def main(args):
    ...
    if (len( sys.argv ) > 1):
        ...
        if (Tau_vs_smear==False):
            ...
            Thermal.thermal_calculo_bis(d3,FINAL_DYN,NQIRR,T=[300],Mesh_range=[10,45,10],smear_range=[0.3,1.0,1]) #smear from 0.01 to 0.1 is too small, do smear from 0.1 to 1.0 or to 2.0
