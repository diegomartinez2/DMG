...
2. With the *load_dyn* function, we will load the dynamical matrix calculated previously with the *ff_calculator* toy potential, so there is no need to calculate it again.
