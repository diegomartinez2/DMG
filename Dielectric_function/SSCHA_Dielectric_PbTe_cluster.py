...
def plot_dispersion(PATH = "GXMGRX", NQIRR = 4, TEMPERATURA = 300, harmonic_dyn='harmonic_dyn', sscha_T_dyn='sscha_T{}_dyn'):
    ...
    sscha_dyn = CC.Phonons.Phonons(sscha_T_dyn.format(TEMPERATURA), NQIRR)
...
def main(args):
    ...
    plot_dispersion(NQIRR = NQIRR,TEMPERATURA = TEMPERATURE, harmonic_dyn = 'pop1/dyn/dynq', sscha_T_dyn='pop13/dyn/dynq')
