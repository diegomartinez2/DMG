...
#
'''
Traducción a python de un programa FORTRAN para el cálculo de modos vibracionales
en nanohilos de longitud infinita mediante el uso de un método analítico
