...
\geometry{
 ...
 left= 37.8mm,%18.9mm,
 top=26.7mm,
 bottom=41mm, % debería ser 53.3mm
 }
\fi
...
\fancyfoot[RE,LO]{{\scriptsize Tu texto de pie de página -- idéntico en cada página izquierda}} % XXX Aquí cambias el texto del pie de página
