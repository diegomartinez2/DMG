...
SUPERCELL_SIZE=2
TEMPERATURE=0
NCONFSSCHA=128      #number of configurations in the sscha ensemble
...
PATH_interface="/media/diego/Calculations/SrTiO3/SSCHA_PHONOPY_VASP/SrTiO3_2x2x2_hessian3/vasp-phonopy-sscha"
echo "============================="
