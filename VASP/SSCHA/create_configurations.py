...
with open('readme.txt', 'w') as f:
    ...
    f.write("a")
    f.write('\n')
    f.write("15.5785322165032696 0.0000000000000000 0.0000000000000000") # str(SUPERCELL(0)*ens.dyn_0.alat)+" 0.0000000000000000"+" 0.0000000000000000"
    f.write('\n')
    f.write("0.0000000000000000 15.5785322165032696 0.0000000000000000") # " 0.0000000000000000"+str(SUPERCELL(0)*ens.dyn_0.alat)+" 0.0000000000000000"
    f.write('\n')
    f.write("0.0000000000000000 0.0000000000000000 15.5785322165032696") # " 0.0000000000000000"+" 0.0000000000000000"+str(SUPERCELL(0)*ens.dyn_0.alat)
    f.write('\n')
    f.write(line_types)
    f.write('\n')
